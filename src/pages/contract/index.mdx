...
export const ContractFunctions = () => {
	...
	return  (
		<p className={styles.emptyState}>No <strong>functions</strong> found for this smart contract.</p>
	);
};
...
export const ContractEvents = () => {
	...
	return (
		<p className={styles.emptyState}>No <strong>events</strong> found for this smart contract.</p>
	);
};
